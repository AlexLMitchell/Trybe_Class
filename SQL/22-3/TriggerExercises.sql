...
-- 1- Crie um TRIGGER que, a cada nova inserção feita na tabela carros, defina o valor
-- da coluna data_atualizacao para o momento do ocorrido, a acao para 'INSERÇÃO' e
-- a coluna disponivel_em_estoque para 1.
...
-- 2- Crie um TRIGGER que, a cada atualização feita na tabela carros, defina o valor da
-- coluna data_atualizacao para o momento do ocorrido e a acao para 'ATUALIZAÇÃO'.
