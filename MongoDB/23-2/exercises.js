...
db.superheroes.count( {"aspects.height": {$gte: 180}} );
...
db.superheroes.count( { "aspects.hairColor": { $in: ["black", "No Hair"] } } ).pretty();

// Exercício 11: Retorne o total de super-heróis que não tenham cabelos pretos ou não sejam carecas.

db.superheroes.count( { "aspects.hairColor": { $nin: ["black", "No Hair"] } } ).pretty();
...
db.superheroes.find(
    { $and:[
        { $or: [{ "aspects.height": 180 }, { "aspects.height": 200 }] }, { publisher: "Marvel Comics" } ]
    } ).pretty();
