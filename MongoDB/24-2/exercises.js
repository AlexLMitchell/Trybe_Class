...
/* Exercício 2: Utilizando o modificador $each, adicione as categorias "villain"
e "comic-based" ao filme Batman. */
...
db.movies.updateOne(
  ...
  {
    $push: {
      cast: { $each: [{ character: 'Batman' }, { character: 'Alfred' }, { character: 'Coringa' }] },
    },
  },
);
...
db.movies.updateOne(
  { title: 'Batman', 'cast.character': 'Joker' },
  { $push: { 'cast.$.actor': 'Heath Ledger' } },
);

/* Exercício 12: Adicione aos atores de cast do character Batman do filme Batman
os valores "Michael Keaton", "Val Kilmer" e "George Clooney", e deixe o array em
ordem alfabética. */
