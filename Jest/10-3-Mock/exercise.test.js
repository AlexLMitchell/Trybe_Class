...
test('1testando se a função foi chamada, qual seu retorno e quantas vezes foi chamada', () => {
...
/* 2- Com a mesma função do exercício anterior, utilizando o mock, crie uma nova implementação que deve
receber dois parâmetros e retornar a divisão do primeiro pelo segundo. Essa implementação deve ocorrer 
uma única vez. Faça os testes necessários. */

test('2testando se a função foi chamada, qual seu retorno, quantas vezes foi chamada e com quais parâmetros', () => {
...
describe('3testando implementações', () => {
